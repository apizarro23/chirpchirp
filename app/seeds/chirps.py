...
def seed_chirps():
    chirp01 = Chirp(
        chirp_content ='Glad to be writing my first chirp!!!',
        user_id = 1,
        image_url = ''
    )
    chirp02 = Chirp(
        chirp_content ='Glad to be writing my first chirp with a picture!!!',
        user_id = 2,
    ...
    chirp03 = Chirp(
        chirp_content ='Look at my new kicks I just picked up',
        user_id = 3,
    ...
    chirp04 = Chirp(
        chirp_content = "The best pizza in the world is at DeLucia's in Raritan, NJ",
        user_id = 4,
        image_url = 'https://10619-2.s.cdn12.com/rests/original/403_503394107.jpg'
    )
    chirp05 = Chirp(
        chirp_content ='Today is the day!',
        user_id = 5,
        image_url = ''
    )
    chirp06 = Chirp(
        chirp_content ='Stopped to get dim sum in Chinatown and it was amazing!!',
        user_id = 6,
        image_url = ''
    )
